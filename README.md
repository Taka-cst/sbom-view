...
アップロードされた SBOM ファイルのコンポーネント一覧をテーブルで表示し、依存関係をインタラクティブなグラフで可視化する。
...
1. ブラウザでアクセスし、SBOM の JSON ファイルをドラッグ＆ドロップまたはファイル選択でアップロード
2. 「テーブル表示」タブでコンポーネント一覧を確認
3. 「依存関係ツリー」タブでグラフを確認
   - ノードをクリックすると子孫を折りたためる
   - 「すべてのノードを表示」ボタンで復元
